...
Use `npm run dev` for the demo. The [launcher](../scripts/demo.ts) supplies the
canonical data directories to the independently buildable [app](../apps/demo/README.md).
